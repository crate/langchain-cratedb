...
class CrateDBToolInput(BaseModel):
    """Input schema for CrateDB tool.
...
class CrateDBTool(BaseTool):  # type: ignore[override]
    """CrateDB tool.
    ...
    args_schema: Type[BaseModel] = CrateDBToolInput

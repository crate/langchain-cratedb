...
class ChatCrateDB(BaseChatModel):
    ...
    """CrateDB chat model integration.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            CrateDB API key. If not passed in will be read from env var CRATEDB_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatCrateDB.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatCrateDB.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatCrateDB supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatCrateDB supports async generation. Otherwise delete.
